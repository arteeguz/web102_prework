...
// set the number of games in the gamesCard
...
function filterUnfundedOnly() {
    ...
    // To find the number of unfunded games 
...
function filterFundedOnly() {
    deleteChildElements(gamesContainer);
     ...
     // To find the number of funded games 
...
const unfundedStatement = `We've raised $${totalRaised.toLocaleString()} for ${GAMES_JSON.length} games, and there ${unfundedGamesCount === 1 ? "is" : "are"} ${unfundedGamesCount} game${unfundedGamesCount === 1 ? "" : "s"} still needing funding.`;

// Create a new DOM element containing the template string and append it to the description container
const newParagraph = document.createElement("p");
newParagraph.innerHTML = unfundedStatement;
